...
func cleanJSONReasonCode(code string) string {
	...
	case "classic_eligible", "agent_state_orphaned", "contains_locked_target", "overlaps_locked_target", "worktree_policy_decision",
		...
		"removed", "partial_failure", "execution_failed", "cancelled", "physical_owner_present", "safety_refused", "execution_set_mismatch", "plan_validation_failed", "cancelled_before_execution", "cancelled_after_confirmation", "cancelled_after_execution", "cancelled_during_confirmation", "confirmation_cancelled", "invalid_confirmation", "not_confirmed", "execution_not_recorded", "execution_state":
		return code
	default:
		return "policy_decision"
	}
