...
func TestIsSafePath(t *testing.T) {
	...
	tests := []struct {
		...
		{"windows local go-build", home + "/AppData/Local/go-build", true},
		...
		{"dart analysis server", home + "/.dartServer", true},
		{"simulator runtimes not safe", home + "/Library/Developer/CoreSimulator", false},
