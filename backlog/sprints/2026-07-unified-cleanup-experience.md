...
- [x] #116 Dogfood the unified cleanup journey on representative homes (~2h)
      → PR #193 (merged `3190874`): representative fixture test + sanitized
      real-home scan/dry-run recorded in `docs/DOGFOOD.md`; review pass
